...
export function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={clsx(
        'fixed lg:relative z-40 lg:z-0 h-full bg-white border-r border-gray-200 transition-transform duration-300 ease-in-out',
        'w-64 flex flex-col',
        ...
        <div className="p-6 border-b border-gray-200">
          <Link href="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-gray-900">API Tutor</span>
          </Link>
        </div>
